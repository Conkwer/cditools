...
Independent implementation based on No$cash CDI specs, cdirip 0.6.4
(DeXT/Lawrence Williams), and the 7-Zip format SDK. No code from Dreambeam,
Iso7z, or any third-party closed-source CDI tool is used.
